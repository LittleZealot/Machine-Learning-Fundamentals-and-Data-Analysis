...
plt.title('Problem 2: Scatter plot visualization')
plt.legend()
plt.show()
...
plt.title('Problem 3: Histogram of Dimension 1')
...
plt.ylabel('Frequency')
plt.title('Problem 3: Histogram of Dimension 2')
...
plt.title('Problem 4: Scatter plot visualization with additional data')
plt.legend()
plt.show()
...
print("Problem 5 & 6: Combined data shape:", combined_data.shape)
